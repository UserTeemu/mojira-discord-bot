...
export default class CustomFeedDatabaseUtil {
    ...
    public static async deleteFeed<R extends QueryResultRow>( table: FeedTables, channel: Snowflake, id: Number ): Promise<QueryResult<R>> {
    ...
    public static async getChannelFeeds<R extends QueryResultRow>( table: FeedTables, channel: Snowflake ): Promise<QueryResult<R>> {
    ...
    public static async getFeeds<R extends QueryResultRow>( table: FeedTables ): Promise<QueryResult<R>> {
